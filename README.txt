Israel 1980s, Version 1.3:
This theater is a mod of the existing Israel theater for Falcon BMS 4.35.


Theater Installation:

-Download and install the official Israel Theater Of Operations for BMS 4.35 at https://www.benchmarksims.org/forum/showthread.php?40653-Israel-Theater-Of-Operations-for-BMS-4-35 (currently version 1.05.2 for BMS 4.35 U1). This is required to use Israel 1980s;
